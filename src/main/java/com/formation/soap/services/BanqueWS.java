 ...
 * 
 */
@WebServiceClient(name = "BanqueWS", targetNamespace = "http://services.soap.formation.com/", wsdlLocation = "http://localhost:8586/BanqueService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANQUEWS_QNAME = new QName("http://services.soap.formation.com/", "BanqueWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8586/BanqueService?wsdl");
    ...
    public BanqueService getBanqueServicePort() {
        return super.getPort(new QName("http://services.soap.formation.com/", "BanqueServicePort"), BanqueService.class);
    }
    ...
    public BanqueService getBanqueServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.soap.formation.com/", "BanqueServicePort"), BanqueService.class, features);
    }
